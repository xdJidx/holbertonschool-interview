...
/**
 * draw_char - Dessine un caractère à l'intérieur d'une grille de
 * coordonnées et de la taille spécifiées.
 *
 * Cette fonction affiche un caractère "#" si les coordonnées (x, y)
 * sont à l'intérieur de la grille de taille size, sinon elle affiche
 * un espace.
 *
